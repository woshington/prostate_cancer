...
A incorporação da perda focal ordinal ao treinamento resultou em melhorias no desempenho do modelo. Embora o coeficiente kappa tenha apresentado aumento modesto (aproximadamente 0,5\%), a análise conjunta com a acurácia revela um ganho superior a 6 pontos percentuais. Esse aumento indica que o modelo treinado com perda focal foi mais preciso nas predições exatas. Essa conclusão é reforçada pela análise das matrizes de confusão apresentadas na Figura~\ref{fig:cm_ordinal_focal}. O modelo sem perda focal (Figura~\ref{subfig:ordinal}) apresenta valores mais baixos na diagonal principal, especialmente para a classe ISUP 3, cuja taxa de acerto foi de 0,365, com grande dispersão para ISUP 2 (0,303) e ISUP 4 (0,212). Já o modelo com perda focal ordinal (Figura~\ref{subfig:ordinal_focal}) apresenta melhorias consistentes em diversas classes, incluindo ISUP 0 (0,857 vs.\ 0,711), ISUP 3 (0,492 vs.\ 0,365) e ISUP 4 (0,652 vs.\ 0,498), evidenciando maior capacidade discriminativa, inclusive nas classes intermediárias, que são tradicionalmente mais difíceis de classificar.
...
\begin{figure}[!htb]
	...
	\hspace{0.2cm} % espaço menor entre as figuras
	...
	\caption{Matrizes de confusão normalizadas dos modelos treinados com perda ordinal 
		(esquerda) e perda ordinal-focal (direita).}
